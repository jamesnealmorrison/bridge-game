    ...
    return (
      <React.Fragment>
        <PageWrap id="page-wrap">
          ...
          <PlayerArea hand={ southHand } direction="SOUTH" gridColumn="2" gridRow="3/5" />
          <PlayerArea hand={ eastHand } direction="EAST" gridColumn="3" gridRow="2/5" />
          <PlayerArea hand={ westHand } direction="WEST" gridColumn="1" gridRow="2/5" />
          <TrickArea />
        </PageWrap>
      </React.Fragment>
    )
